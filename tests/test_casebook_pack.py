"""Regression checks for the zenith-svc-billing-mesh casebook."""
...
from casebook.harness import assert_expected, zenith_svc_billing_mesh_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(zenith_svc_billing_mesh_summary(), assert_expected())
